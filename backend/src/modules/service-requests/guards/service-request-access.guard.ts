...
import { ApiException, forbidden, invalidToken } from "../../../common/errors/api-exception";
...
export class ServiceRequestAccessGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    if (qr) {
      ...
      request.serviceRequestAccessContext = { kind: "qr", qr };
      return true;
    }
    ...
    request.serviceRequestAccessContext = { kind: "staff", branch };
    return true;
  }
